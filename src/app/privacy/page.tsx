        ...
        <div className="prose prose-sm prose-gray max-w-none space-y-8 text-gray-600 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li>
                <span className="text-gray-900 font-medium">Datos de la tienda:</span> nombre de
                tienda, dominio y tokens de acceso OAuth cuando conectás tu tienda Tiendanube.
              </li>
              <li>
              ...
              <li>
                <span className="text-gray-900 font-medium">Datos de conversión:</span> órdenes,
                montos y códigos de descuento asociados a creators en tus campañas.
              </li>
              <li>
                <span className="text-gray-900 font-medium">Datos de tracking:</span> el script de
                Kool guarda una cookie (
                <code className="text-xs bg-gray-100 px-1 py-0.5 rounded">kool_ref</code>) en el
                navegador del visitante para atribuir conversiones, con vencimiento de 30 días.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-2 mt-2">
              <li>
                <span className="text-gray-900 font-medium">Tiendanube:</span> para sincronizar
                órdenes, coupons y webhooks a través de su API oficial.
              </li>
              <li>
                <span className="text-gray-900 font-medium">Clerk:</span> proveedor de
                autenticación.
              </li>
              <li>
                <span className="text-gray-900 font-medium">Vercel:</span> infraestructura de
                hosting.
              </li>
          ...
          <section>
            ...
            <p>
              ...
              cambios significativos. El uso continuado de Kool implica la aceptación de la política
              vigente.
            </p>
          </section>

      ...
      <div className="flex items-center justify-between mb-6 lg:mb-8">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1 hidden sm:block">
            Organizá tus acciones con creators por campaña
          </p>
        </div>
        <button
          ...
          campaigns.map((campaign) => {
            ...
            return (
              <a
                ...
                className="block bg-white rounded-xl border border-gray-100 p-5 hover:border-gray-200 transition-[box-shadow,border-color] duration-base ease-out-strong hover:shadow-card"
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2 mb-1 flex-wrap">
                      ...
                      {formCfg && (
                        <span
                          className={`text-[11px] px-2 py-0.5 rounded-full font-medium ${formCfg.style}`}
                        >
                      ...
                      {campaign.pendingApplications > 0 && (
                        <span className="flex items-center gap-1 text-[11px] px-2 py-0.5 rounded-full font-medium bg-brand-50 text-brand-700">
                          <Clock size={10} />
                          {campaign.pendingApplications} pendiente
                          {campaign.pendingApplications !== 1 ? "s" : ""}
                        </span>
                      )}
                    </div>

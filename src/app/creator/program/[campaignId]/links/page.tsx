...
export default async function LinksPage({ params }: { params: Promise<{ campaignId: string }> }) {
    ...
    <div className="p-4 lg:p-8 max-w-4xl mx-auto space-y-5">
      <div className="mb-2">
        ...
        <p className="text-sm text-gray-400 mt-0.5">
          {links.length} link{links.length !== 1 ? "s" : ""} activo{links.length !== 1 ? "s" : ""}
        </p>
      </div>
              ...
              <div className="flex items-start gap-4">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-[14px] font-mono font-medium text-gray-900">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <CopyLinkButton value={buildShortUrl(link.slug)} />
                </div>
              </div>
            </div>
          ))}
